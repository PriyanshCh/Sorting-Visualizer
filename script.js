...
function createArray() {
    ...
    for (var i = 0; i < size; i++) {
        ...
        // Add a <span> element for displaying the number
        var $numberSpan = $('<span>');
        $numberSpan.text(i+1); // Set the text to the array element value
        $numberSpan.addClass('element-number'); // You can add CSS class for styling
        $element.append($numberSpan);
...
$(document).ready(function() {
    ...
    $(".algo-btn").click(
        function() {
            ...
            updateComplexityText(algo_selected);
        }
    );
    ...
    function updateComplexityText(algorithm) {
        var timeComplexity = "";
        var spaceComplexity = "";
        ...
        // Update the time and space complexities in the HTML
        $("#time-complexity").html(timeComplexity);
        $("#space-complexity").html(spaceComplexity);
    }
    // ooo
